      ...
      <div className="flex flex-col">
        ...
        <div className="bg-white text-black py-16 ">
          <div className="container mx-auto px-6 flex flex-col justify-center items-center">
            ...
            <button className="bg-white text-black px-8 py-3 ring-1 ring-black rounded-full font-bold hover:bg-black hover:text-white transition duration-200">
              Apply Now
            </button>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:scale-110 transition duration-400"> 
                <div className="w-full h-48 bg-gray-200 rounded mb-4 flex items-center justify-center">
                  ...
                  <img src="../assets/flexibleSchedule2.jpg" className="w-full h-full" alt="" />
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:scale-110 transition duration-400">
                <div className="w-full h-48 bg-gray-200 rounded mb-4 flex items-center justify-center">
                <img src="../assets/comp-earning.jpg" className="w-full h-full" alt="" />
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:scale-110 transition duration-400">
                <div className="w-full h-48 bg-gray-200 rounded mb-4 flex items-center justify-center">
                <img src="../assets/training.jpg" className="w-full h-full" alt="" />
                </div>
